<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminallreports.aspx.cs"
    Inherits="nexora.admindashboard" %>
    ...
    <div class="container">
        ...
        <div class="box-container">
            <asp:Repeater ID="rptReports" runat="server">
                <ItemTemplate>
                    <div class="box">
                        ...
                        <p>Manage and view system data securely.</p>
                         <asp:LinkButton
                            ID="lnkReadMore"
                            runat="server"
                            CssClass="btn"
                            Text="Read More"
                            CommandArgument='<%# Eval("SL_NO") %>'
                            OnClick="lnkReadMore_Click"
            ...
            <div class="box">
                ...
                <p>Form creation</p>
                <a href="adminfrmcreation.aspx" class="btn">Open</a>
            </div>
        </div>
